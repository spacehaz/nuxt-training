<template>
  <main class="policy root__policy">
    <div class="policy__container">
      ...
      <div class="policy__content">
        <div class="policy__content-item">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">2.</span>
            <p class="policy__text">
        ...
        <div class="policy__content-item">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">3.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">4.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">5.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">6.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">7.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">8.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">9.</span>
            <p class="policy__text">
              Пользователь – любой посетитель веб-сайта http://raklechitsa.ru;
            </p>
          </div>
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">10.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">11.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">12.</span>
            <p class="policy__text">
          ...
          <div class="policy__paragraph policy__paragraph_numbered">
            <span class="policy__number">13.</span>
            <p class="policy__text">
